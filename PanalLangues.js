...
var VTR = {
 ca: [
  {tit:'Benvinguda al Panal Salufolio',txt:'Esta és la casa de Salufolio: <strong>dos pisos i set portes per pis</strong>. En un minut sabrà què oferix cada una i quina és la seua. El film avança sol, a poc a poc — <em>«Seguir» per a avançar, llisque el dit arrere per a repassar, ✕ per a eixir quan vullga.</em> Quan un text no càpia sencer, <strong>llisque amb el dit</strong>, cap amunt o cap avall — ací i en cada porta.'},
 ...
 en: [
  {tit:'Welcome to the Salufolio hive',txt:'This is Salufolio\'s house: <strong>two floors and seven doors per floor</strong>. In one minute you will know what each one offers and which one is yours. The film moves on its own, slowly — <em>"Next" to go forward, swipe back to review, ✕ to leave whenever you wish.</em> When a text does not fit, <strong>slide it with your finger</strong>, up or down — here and at every door.'},
